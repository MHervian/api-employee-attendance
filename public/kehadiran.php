...
<head>
    ...
    <title>Histori Absensi Karyawan - Aplikasi Absensi</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">List Data Karyawan</h1>
                    <?php
                    // echo "<pre>";
                    // var_dump($result);
                    // echo "</pre>";
                    ...
                    ?>
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Pilih salah satu data untuk melihat detail absensi
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $result->nama ?></td>
                                                <td>
                                                    <a href="detail_absensi.php?id_karyawan=<?= $result->id ?>">Riwayat Absensi</a>
                                                </td>
                                            </tr>
                                        <?php
                                        $no++;
