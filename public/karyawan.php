...
// Query API /karyawan
$curl->get('http://localhost:5000/karyawan');
...
<head>
    ...
    <title>Data Karyawan - Aplikasi Absensi</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    ?>
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Data karyawan yang terdaftar di sistem
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $result->nama ?></td>
                                                <td>
                                                    <a href="formkaryawan.php?id_karyawan=<?= $result->id ?>" class="btn btn-primary">Edit</a>
                                                    <a href="modules/delete_karyawan.php?id_karyawan=<?= $result->id ?>" class="btn btn-danger">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php
                                            $no++;
                    ...
                    ?>
                        <p class="bg-info text-center">Tidak ada data karyawan.</p>
                    <?php
                    }
                    ?>
                </div>
